...
RDBMS is a relational database management system. SQL is the language used in the system.

1. Why do tables need a `primary key`?

To keep track of data; they function as ids.
...
A third intermediary table with two foreign keys referencing to the primary keys of the other two tables.
